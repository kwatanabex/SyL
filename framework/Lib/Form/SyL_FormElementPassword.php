 ...
 * @link       http://syl.jp/
 */
class SyL_FormElementPassword extends SyL_FormElementAbstract
{
    /**
     * フォーム要素HTML出力（入力項目）
     *
    ...
    protected function getHtmlTag()
    {
        ...
        $this->setAttribute('password', 'type');
    ...
    {
        $label = ($this->value != '') ? '********' : '';
        return $this->getHtmlSpan($this->name, $label) . $this->getHtmlHidden();
    }
}
