 ...
 * @link       http://syl.jp/
 */
class SyL_WebServiceSearchWebunitRequest extends SyL_WebServiceSearchRequest
{
    /**
     * 実行URLパス
     *
     * @var string
     */
    protected $path = '/AssistSearchService/V1/webunitSearch';
}
